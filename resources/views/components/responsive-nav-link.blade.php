...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-green-500 text-start text-base font-medium text-white bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 focus:border-green-700 transition duration-150 ease-in-out'
